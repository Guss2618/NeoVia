import { ArrowLeft, BusFront, Clock3 } from "lucide-react";
      ...
      <section className="mx-auto w-full max-w-4xl">
        ...
        <section className="mt-8 rounded-[32px] bg-white p-6 shadow-card sm:p-8">
          ...
          <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
            Em breve, esta tela exibira as linhas, horarios de saida e filtros
            para encontrar o transporte ideal com mais facilidade.
          </p>
